    ...
    return (
      <div className={`fortress-bg ${isAnchor ? 'anchor-theme' : ''}`}>
        ...
        <div className="nav-left">
          <a href="https://github.com/collar2023/mail-to" target="_blank" rel="noopener noreferrer" className="github-link" title="Source Code">
        ...
        <div className="status-badge">{isClaimed ? '✅ 已签收' : '⏳ 待签收'}</div>
      </header>
